...
setup(
    name = 'janitoo_nosetests_flask',
    description = "Test tools and classes for janitoo flask applications",
    long_description = "Test tools and classes for janitoo flask application",
